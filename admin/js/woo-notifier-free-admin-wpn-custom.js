        ...
        buttons: [
            {
                ...
                click: function() {
                    ...
                    var email_id = jQuery('#txt_user_sub_wpnfree').val();
                    var data = {
                        'action': 'add_plugin_user_wpnsfree',
                        'email_id': email_id
                    };
                    // since 2.8 ajaxurl is always defined in the admin header and points to admin-ajax.php
                    jQuery.post(ajaxurl, data, function(response) {
                        jQuery('#wpnfree_dialog').html('<h2>You have been successfully subscribed');
